...
class tst_QSparseSet : public QObject
{
    Q_OBJECT
...
void tst_QSparseSet::operator_eq()
{
    {
        QSparseSet<int> set1, set2;
        QVERIFY(set1 == set2);
        QVERIFY(!(set1 != set2));
    ...
    {
        QSparseSet<QString> a;
        QSparseSet<QString> b;
...
void tst_QSparseSet::swap()
{
    QSparseSet<int> s1, s2;
    s1.insert(1);
    s2.insert(2);
    s1.swap(s2);
    QCOMPARE(*s1.begin(),2);
...
void tst_QSparseSet::capacity()
{
    QSparseSet<int> set(-1);
//    int n = set.capacity();
//    QVERIFY(n == 0);
...
void tst_QSparseSet::detach()
{
    ...
    QSparseSet<int> copy = set;
    set.detach();
}

void tst_QSparseSet::isDetached()
{
//    QSparseSet<int> set1, set2;
...
void tst_QSparseSet::remove()
{
    QSparseSet<QString> set1;
...
void tst_QSparseSet::containsSet()
{
    QSparseSet<QString> set1;
    QSparseSet<QString> set2;
    set1.set_deleted_key(QString("deleted"));
    ...
    const QSparseSet<QString> set4;
    QVERIFY(set3.contains(set4));
}

void tst_QSparseSet::begin()
{
    QSparseSet<int> set1;
    QSparseSet<int> set2 = set1;

    {
        QSparseSet<int>::const_iterator i = set1.constBegin();
        QSparseSet<int>::const_iterator j = set1.cbegin();
        QSparseSet<int>::const_iterator k = set2.constBegin();
        QSparseSet<int>::const_iterator ell = set2.cbegin();
...
void tst_QSparseSet::end()
{
    QSparseSet<int> set1;
    QSparseSet<int> set2 = set1;

    {
        QSparseSet<int>::const_iterator i = set1.constEnd();
        QSparseSet<int>::const_iterator j = set1.cend();
        QSparseSet<int>::const_iterator k = set2.constEnd();
        QSparseSet<int>::const_iterator ell = set2.cend();
...
void tst_QSparseSet::setOperations()
{
    QSparseSet<QString> set1, set2;
    ...
    QSparseSet<QString> set7 = set1;
    set7.subtract(set2);
    QVERIFY(set7.size() == 2);
    QVERIFY(set7.contains("alpha"));
    QVERIFY(set7.contains("zeta"));

    QSparseSet<QString> set8 = set2;
    set8.subtract(set1);
    QVERIFY(set8.size() == 2);
    QVERIFY(set8.contains("epsilon"));
    QVERIFY(set8.contains("iota"));

    QSparseSet<QString> set9 = set1 | set2;
    QVERIFY(set9 == set3);

    QSparseSet<QString> set10 = set1 & set2;
    QVERIFY(set10 == set5);

    QSparseSet<QString> set11 = set1 + set2;
    QVERIFY(set11 == set3);

    QSparseSet<QString> set12 = set1 - set2;
    QVERIFY(set12 == set7);

    QSparseSet<QString> set13 = set2 - set1;
    QVERIFY(set13 == set8);

    QSparseSet<QString> set14 = set1;
    set14 |= set2;
    QVERIFY(set14 == set3);

    QSparseSet<QString> set15 = set1;
    set15 &= set2;
    QVERIFY(set15 == set5);

    QSparseSet<QString> set16 = set1;
    set16 += set2;
    QVERIFY(set16 == set3);

    QSparseSet<QString> set17 = set1;
    set17 -= set2;
    QVERIFY(set17 == set7);

    QSparseSet<QString> set18 = set2;
    set18 -= set1;
    QVERIFY(set18 == set8);
}

void tst_QSparseSet::stlIterator()
{
    QSparseSet<QString> set1;
    ...
    {
        int sum = 0;
        QSparseSet<QString>::const_iterator i = set1.begin();
        while (i != set1.end()) {
            sum += toNumber(*i);
            ++i;
        }
    ...
    {
        int sum = 0;
        QSparseSet<QString>::const_iterator i = set1.end();
        while (i != set1.begin()) {
            --i;
            sum += toNumber(*i);
        }
...
void tst_QSparseSet::stlMutableIterator()
{
    QSparseSet<QString> set1;
    for (int i = 0; i < 25000; ++i)
        set1.insert(QString::number(i));
    ...
    {
        int sum = 0;
        QSparseSet<QString>::iterator i = set1.begin();
        while (i != set1.end()) {
            sum += toNumber(*i);
            ++i;
        }
    ...
    {
        int sum = 0;
        QSparseSet<QString>::iterator i = set1.end();
        while (i != set1.begin()) {
            --i;
            sum += toNumber(*i);
        }
    ...
    {
        QSparseSet<QString> set2 = set1;
        QSparseSet<QString> set3 = set2;
        set2.set_deleted_key(QString("deleted"));
        set3.set_deleted_key(QString("deleted"));

        QSparseSet<QString>::iterator i = set2.begin();
        QSparseSet<QString>::iterator j = set3.begin();
...
//         i = set2.insert("foo");
// #else
        QSparseSet<QString>::const_iterator k = set2.insert("foo");
        i = reinterpret_cast<QSparseSet<QString>::iterator &>(k);
// #endif
        QVERIFY(*i == "foo");
    }
}

void tst_QSparseSet::javaIterator()
{
    QSparseSet<QString> set1;
    set1.set_deleted_key(QString("deleted"));
    ...
    {
        int sum = 0;
        QSparseSetIterator<QString> i(set1);
        while (i.hasNext())
            sum += toNumber(i.next());
        QVERIFY(sum == 24999 * 25000 / 2);
    }
    ...
    int sum2 = 0;
    QSparseSetIterator<QString> i(set1);
    QSparseSetIterator<QString> j(set1);
...
void tst_QSparseSet::javaMutableIterator()
{
    QSparseSet<QString> set1;
    set1.set_deleted_key(QString("deleted"));
    for (int k = 0; k < 25000; ++k)
    ...
    {
        int sum = 0;
        QMutableSparseSetIterator<QString> i(set1);
        while (i.hasNext())
            sum += toNumber(i.next());
        QVERIFY(sum == 24999 * 25000 / 2);
    }
...

    {
        ...
        QMutableSparseSetIterator<QString> i(set2);
        QMutableSparseSetIterator<QString> j(set3);
...
void tst_QSparseSet::makeSureTheComfortFunctionsCompile()
{
    QSparseSet<int> set1, set2, set3;
    set1.set_deleted_key(-1);
...
QTEST_APPLESS_MAIN(tst_QSparseSet)

#include "tst_qsparseset.moc"
